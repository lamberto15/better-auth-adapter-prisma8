...
- [ ] If this touches query translation, the generators, or anything the [official conformance suite](../CONTRIBUTING.md#running-the-conformance-suite) exercises: ran it locally against a real Postgres (`LIVE_PG_URL=... pnpm test`) and it's green
